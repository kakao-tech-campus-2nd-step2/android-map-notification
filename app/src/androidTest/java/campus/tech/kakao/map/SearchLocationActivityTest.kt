...
class SearchLocationActivityTest {
    ...
    @Inject
    lateinit var mockHistoryRepository: HistoryRepository
    @Inject
    lateinit var mockLastLocationRepository: SearchLocationRepository
    @Inject
    lateinit var mockSearchLocationRepository: SearchLocationRepository
